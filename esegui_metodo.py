...
def Metodi(name_dataset, method,joblib_num_jobs, X,y, Caratteristiche, Campioni, file_excel):
    ...
    if method =="gradient_descent":
        ...
        path_img_GD=plot_loss_and_gradient(Loss_gradient_descent_complete, Gradient_norm_gradient_descent_complete,gradient_norm_slope_gd,gradient_slope_gd, "Gradient Descent",save_dir="plots_"+name_dataset)
    ...
    if method =="gradient_descent_armijo":
        ...
        path_img_GDA=plot_loss_and_gradient(Loss_gradient_descent_armijo_complete, Gradient_norm_gradient_descent_armijo_complete,gradient_norm_slope_gda,gradient_slope_gda, "Gradient Descent Armijo",save_dir="plots_"+name_dataset)
    ...
    if method =="jacobi":
        ...
        model_jacobi = Jacobi(num_blocks, lambda_reg, tol, max_iter,num_jobs)
        ...
        path_img_J=plot_loss_and_gradient(Loss_jacobi_complete, Gradient_norm_jacobi_complete,gradient_norm_slope_j,gradient_slope_j, "Jacobi",save_dir="plots_"+name_dataset)
    ...
    if method =="gauss_seidel":
        ...
        model_gauss_seidel = GaussSeidel(num_blocks, lambda_reg, tol, max_iter)
        
        #print(f"  Numero di blocchi:{num_blocks}\n  Lambda:{lambda_reg}\n  Tolleranza:{tol} ")
        #print("---------------------------------------------------------------")
        #print("** Applico il metodo **")
        Loss_gauss_seidel_complete,Gradient_norm_gauss_seidel_complete,Gradient_gauss_seidel_complete,w_opt,iterazioni = model_gauss_seidel.gauss_seidel(X, y)
        #print("\n** Calcolo i pesi **")
        ...
        path_img_GS=plot_loss_and_gradient(Loss_gauss_seidel_complete, Gradient_norm_gauss_seidel_complete,gradient_norm_slope_gs,gradient_slope_gs, "Gauss-Seidel",save_dir="plots_"+name_dataset)
